...
/// <reference path="classes/basic/Size.ts"/>
/// <reference path="classes/basic/Circle.ts"/>
...
/// <reference path="classes/utils/UtilsCollisions.ts"/>
/// <reference path="classes/utils/UtilsMouse.ts"/>